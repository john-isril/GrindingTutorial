...
#include "GrindingTutorialCharacter.generated.h"
 ...
 */
UCLASS(abstract)
class AGrindingTutorialCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	/** Constructor */
	AGrindingTutorialCharacter(const FObjectInitializer& ObjectInitializer);
